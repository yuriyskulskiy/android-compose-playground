package com.skul.yuriy.composeplayground.feature.customBlur.effects.threeZones.effects
...
/**
 * Temporary ultra-quality test variant (101 taps, -50..50) for large radii.
 * Intended for visual comparison only.
 */
fun Modifier.alphaGaussianBlurThreeZoneTest101(
    radius: Dp,
    ...
    val effect = rememberAlphaGaussianBlurThreeZoneEffectTest101(
...
private const val AlphaGaussianBlur101TapThreeZoneAglsl = """
uniform shader src;
uniform float2 uDir;
...
private const val AlphaGaussianBlur101TapThreeZoneTintAglsl = """
uniform shader src;
uniform float2 uDir;
uniform float  uMaxRadius; // px
uniform float  uHeight;    // px
...
@Composable
private fun rememberAlphaGaussianBlurThreeZoneEffectTest101(
    maxRadiusPx: Float,
    heightPx: Int,
    topPx: Float,
    bottomPx: Float,
    ...
    return remember(r, h, tPx, bPx, color) {
        val rtH = RuntimeShader(AlphaGaussianBlur101TapThreeZoneAglsl).apply {
        ...
        val rtV = RuntimeShader(AlphaGaussianBlur101TapThreeZoneTintAglsl).apply {
