 ...
 */
fun Modifier.alphaGaussianBlurLocalDynamicThreeZoneTest101(
    radius: Dp,
    ...
    val effect = rememberAlphaGaussianBlurLocalDynamicThreeZoneEffectTest101(
...
@Composable
private fun rememberAlphaGaussianBlurLocalDynamicThreeZoneEffectTest101(
    maxRadiusPx: Float,
    heightPx: Int,
    topPx: Float,
    bottomPx: Float,
