 ...
 */
fun Modifier.alphaLinearBlurLocalDynamicThreeZone(
    radius: Dp,
    ...
    val effect = rememberAlphaLinearBlurLocalDynamicThreeZoneEffect(
...
@Composable
private fun rememberAlphaLinearBlurLocalDynamicThreeZoneEffect(
    maxRadiusPx: Float,
    heightPx: Int,
    topPx: Float,
    bottomPx: Float,
