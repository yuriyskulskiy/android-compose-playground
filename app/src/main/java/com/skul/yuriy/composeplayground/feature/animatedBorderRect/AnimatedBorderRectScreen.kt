...
fun AnimatedBorderRectScreen() {
    ...
    Box(
        ...
        OutlinedButton(
            onClick = { isBorderEnabled = !isBorderEnabled },
            modifier = Modifier
            ...
            Text(
                text = if (isBorderEnabled) {
                    stringResource(R.string.composable_border_on)
                } else {
                    stringResource(R.string.composable_border_off)
                }
            )
        }
